...
const InterviewCodingQuestions = () => {
    ...
    const loadArticles = async() => {
        try {
            const data = await articleService.getAllArticles(
                CATEGORY_QUERY_PARAMS[TECH_STACK_CATEGORIES.INTERVIEW_CODING_QUESTIONS]
            );
            setArticles(data);
        } catch (error) {
    ...
    return ( <
        ...
        serviceType = { TECH_STACK_CATEGORIES.INTERVIEW_CODING_QUESTIONS }
        />
    );
};

export default InterviewCodingQuestions;